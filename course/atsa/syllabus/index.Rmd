...
:   Exercises should be completed using either the R command line or RStudio.
    ...
    Exercises that are submitted on time and you fixed any problems (based on feedback) such that they produce the expected outputs and run without errors, receive a check.
...
:   This semester, we will examine the application of time series analysis to audio files.
    ...
    1. An insightful reflection on methods, challenges, and what you were able to accomplish.
